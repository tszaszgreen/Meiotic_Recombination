      seqfile = all_genes.fasta            * Path to the alignment file
     treefile = all.tree           * Path to the tree file
      outfile = all_genes_M8A_mlc      * Path to the output file
   
        noisy = 9                     * How much rubbish on the screen
      verbose = 1                     * More or less detailed report

      seqtype = 1                     * Data type
        ndata = 16 maintree           * Number of data sets or loci
