seqfile = rad21l1_noMNM.fasta * sequence data filename
     treefile = rad21l1_tree.txt      * tree structure file name
      outfile = RAD21L1_noMNM_M8A_mlc           * main result file name
