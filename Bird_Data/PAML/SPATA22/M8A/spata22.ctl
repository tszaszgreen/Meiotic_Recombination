seqfile = spata22_noMNM.fasta * sequence data filename
     treefile = spata22_tree.txt      * tree structure file name
      outfile = spata22_noMNM_m8a_mlc           * main result file name
